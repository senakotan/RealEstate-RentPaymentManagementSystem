...
namespace EmlakYonetimAPI.Controllers
{
    ...
    public class MulkController : ControllerBase
    {
        ...
        // Parametreleri ekleyen yardýmcý metot (Insert ve Update için ortak)
        ...
        private string? ValidateMulk(Mulk m)
        {
            ...
            // Oda sayýsý '3+1' gibi format kontrolü
        ...
        // Generic varlýk kontrolü (Kullanýcý var mý? Ýlçe var mý?)
        ...
        // --- GEÇÝCÝ ÝLÇE METOTLARI (Ýleride SozlukController'a taþýnabilir) ---
        [HttpGet("ilceAra")]
